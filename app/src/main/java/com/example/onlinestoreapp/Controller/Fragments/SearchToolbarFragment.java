...
import com.example.onlinestoreapp.Controller.Activities.FilterActivity;
...
public class SearchToolbarFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backBtn.setIconTint(getResources().getColorStateList(R.color.gray));
        voiceRecognitionBtn.setIconTint(getResources().getColorStateList(R.color.gray));
        closeSearchBtn.setIconTint(getResources().getColorStateList(R.color.gray));
